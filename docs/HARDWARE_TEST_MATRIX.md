...
| 14 | Storage | microSD I/O | `dd if=/dev/zero of=/tmp/test bs=1M count=10` | Write completes | Stable mounts, no eMMC writes in dmesg | — |
...
| 19 | Dashboard | Hardware monitor | Check existing dashboard collectors | Collectors report | No new critical failures | — |
